...
syscall_info_t syscall_gdi32_info[] = {
    ...
    { { 0, 0 },
      "NtGdiPolyPolyDraw",
      OK | SYSINFO_RET_ZERO_FAIL | SYSINFO_RET_TYPE_VARIES,
    ...
    { { 0, 0 },
      ...
      1,
      {
          { 0, sizeof(D3DNTHAL_VALIDATETEXTURESTAGESTATEDATA), R | W | HT,
            DRSYS_TYPE_STRUCT },
      } },
    { { 0, 0 },
    ...
    { { 0, 0 },
      ...
      8,
      {
          ...
          { 2, sizeof(BITMAPINFO) + ((/*MAX_COLORTABLE*/ 256 - 1) * sizeof(RGBQUAD)),
            R | W | HT, DRSYS_TYPE_BITMAPINFO },
    ...
    { { 0, 0 },
      ...
      9,
      {
          ...
          { 6, sizeof(int), SYSARG_INLINED, DRSYS_TYPE_SIGNED_INT },
          { 7, -6, R | SYSARG_SIZE_IN_ELEMENTS,
            sizeof(INT) /*can be larger: special-cased*/ },
          { 8, sizeof(DWORD), SYSARG_INLINED, DRSYS_TYPE_UNSIGNED_INT },
      },
    ...
    { { WIN2K, 0 },
      ...
      {
          /*special-cased*/
          { 0, -1, SYSARG_NON_MEMARG | SYSARG_SIZE_IN_ELEMENTS,
    ...
    { { 0, 0 },
      ...
      8,
      {
          ...
          { 5, sizeof(ULONG), SYSARG_INLINED, DRSYS_TYPE_UNSIGNED_INT },
          { 6, sizeof(ULONG), R | W | SYSARG_IGNORE_IF_NEXT_NULL | HT,
            DRSYS_TYPE_UNSIGNED_INT },
    ...
    { { 0, 0 },
      ...
      3,
      {
          ...
          { 1, sizeof(ULONG), R | W | HT,
            DRSYS_TYPE_UNSIGNED_INT }, /*XXX: I'm assuming R: else how know? prior syscall
                                          (i#485)?*/
...
#define NUM_GDI32_SYSCALLS (sizeof(syscall_gdi32_info) / sizeof(syscall_gdi32_info[0]))
